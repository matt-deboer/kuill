...
import { arraysEqual, objectEmpty, keyForResource, isResourceOwnedBy, sameResource } from '../../comparators'
...
export function applyResourceChanges(namespace, kind, name, contents) {
  return async function (dispatch, getState) {
      ...
      dispatch(routerActions.push({
        pathname: forResource({name: name, namespace: namespace, kind: kind}),
        search: '?view=events',
        hash: '',
      }))
  }
